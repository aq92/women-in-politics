...
load("/Users/ahmad/Downloads/cses_imd.rdata")

#Recode 

#DV: Satisfaction with Democracy 
    cses_imd$Satisfaction <- NA
    cses_imd$Satisfaction[cses_imd$IMD3010 == 1] <- 4
    cses_imd$Satisfaction[cses_imd$IMD3010 == 2] <- 3
    cses_imd$Satisfaction[cses_imd$IMD3010 == 4] <- 2
    cses_imd$Satisfaction[cses_imd$IMD3010 == 5] <- 1

#Income 
    cses_imd$Income <- NA
    cses_imd$Income[cses_imd$IMD2006 == 1] <- 1 
    cses_imd$Income[cses_imd$IMD2006 == 2] <- 2 
    cses_imd$Income[cses_imd$IMD2006 == 3] <- 3 
    cses_imd$Income[cses_imd$IMD2006 == 4] <- 4 
    cses_imd$Income[cses_imd$IMD2006 == 5] <- 5
    
#Education 
    cses_imd$Education <- NA
    cses_imd$Education[cses_imd$IMD2003 == 0] <- 0     
    cses_imd$Education[cses_imd$IMD2003 == 1] <- 1 
    cses_imd$Education[cses_imd$IMD2003 == 2] <- 2 
    cses_imd$Education[cses_imd$IMD2003 == 3] <- 3 
    cses_imd$Education[cses_imd$IMD2003 == 4] <- 4 

#Gender
    cses_imd$Female <- NA
    cses_imd$Female[cses_imd$IMD2002 == 1] <- 0     
    cses_imd$Female[cses_imd$IMD2002 == 2] <- 1     
    
#Age    
    cses_imd$Age <- cses_imd$IMD2001_1
    cses_imd$Age[cses_imd$IMD2001_1 == 9997] <- NA    
    cses_imd$Age[cses_imd$IMD2001_1 == 9998] <- NA        
    cses_imd$Age[cses_imd$IMD2001_1 == 9999] <- NA        
    
#Country Year
    cses_imd$Country_year <- cses_imd$IMD1004
    
#Partsian vs. Non-Partisan 
    cses_imd$Partisan <- NA
    cses_imd$Partisan[cses_imd$IMD3005_1 == 0] <- 0
    cses_imd$Partisan[cses_imd$IMD3005_1 == 1] <- 1
    
#What Party? Sync party id of Cses to V-party 
    #CSES Parties 
...
#Regime (0 parliamentary; 1 semi-presidential; 2 presidential) source Williams et al. from Bormann and golder (2013)
    cses_imd$regimetype <- 0
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Brazil"] <- 2
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Chile"] <- 2
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Croatia"] <- 1
    cses_imd$regimetype[cses_imd$IMD1004 == "CZE_2013"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Finland"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "France"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Iceland"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Ireland"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Kenya"] <- 2
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Kyrgyzstan"] <- 2
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Lithuania"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Mexico"] <- 2
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Peru"] <- 2
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Philippines"] <- 2
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Poland"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Portugal"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Romania"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Russia"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Serbia"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Slovakia"] <- 1
    cses_imd$regimetype[cses_imd$IMD1004 == "SVN_1996"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "South Africa"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "South Korea"] <- 2
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Taiwan"] <- 1
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "United States of America"] <- 2
    cses_imd$regimetype[cses_imd$IMD1006_NAM == "Uruguay"] <- 2
    
#Partisan in power checked by date of survey and assumption of office
    
    cses_imd$partywon <- NA
    cses_imd$partywon[cses_imd$Country_year == "AUS_2013"] <- 486
    cses_imd$partywon[cses_imd$Country_year == "AUT_2008"] <- 1384
    cses_imd$partywon[cses_imd$Country_year == "AUT_2013"] <- 1384
    cses_imd$partywon[cses_imd$Country_year == "BELF1999"] <- 49
    cses_imd$partywon[cses_imd$Country_year == "BELW1999"] <- 49
    cses_imd$partywon[cses_imd$Country_year == "BEL_2003"] <- 49
    cses_imd$partywon[cses_imd$Country_year == "BGR_2001"] <- 1183
    cses_imd$partywon[cses_imd$Country_year == "BGR_2014"] <- 760
    cses_imd$partywon[cses_imd$Country_year == "BRA_2002"] <- 225
    cses_imd$partywon[cses_imd$Country_year == "BRA_2006"] <- 356
    cses_imd$partywon[cses_imd$Country_year == "BRA_2010"] <- 356
    cses_imd$partywon[cses_imd$Country_year == "BRA_2014"] <- 356
    cses_imd$partywon[cses_imd$Country_year == "CAN_1997"] <- 1739
    cses_imd$partywon[cses_imd$Country_year == "CAN_2004"] <- 1739
    cses_imd$partywon[cses_imd$Country_year == "CAN_2008"] <- 1004
    cses_imd$partywon[cses_imd$Country_year == "CAN_2011"] <- 1004
    cses_imd$partywon[cses_imd$Country_year == "CAN_2015"] <- 1739
    cses_imd$partywon[cses_imd$Country_year == "CHL_2005"] <- 54
    cses_imd$partywon[cses_imd$Country_year == "CZE_1996"] <- 466
    cses_imd$partywon[cses_imd$Country_year == "CZE_2002"] <- 177
    cses_imd$partywon[cses_imd$Country_year == "CZE_2006"] <- 466
    cses_imd$partywon[cses_imd$Country_year == "CZE_2010"] <- 466
    cses_imd$partywon[cses_imd$Country_year == "CZE_2013"] <- 466
    cses_imd$partywon[cses_imd$Country_year == "DEU12002"] <- 383
    cses_imd$partywon[cses_imd$Country_year == "DEU22002"] <- 383
    cses_imd$partywon[cses_imd$Country_year == "DEU_1998"] <- 383
    cses_imd$partywon[cses_imd$Country_year == "DEU_2005"] <- 211
    cses_imd$partywon[cses_imd$Country_year == "DEU_2009"] <- 211
    cses_imd$partywon[cses_imd$Country_year == "DEU_2013"] <- 211
    cses_imd$partywon[cses_imd$Country_year == "DNK_1998"] <- 379
    cses_imd$partywon[cses_imd$Country_year == "DNK_2001"] <- 1204
    cses_imd$partywon[cses_imd$Country_year == "DNK_2007"] <- 1204
    cses_imd$partywon[cses_imd$Country_year == "ESP_1996"] <- 441
    cses_imd$partywon[cses_imd$Country_year == "ESP_2000"] <- 441
    cses_imd$partywon[cses_imd$Country_year == "ESP_2004"] <- 1338
    cses_imd$partywon[cses_imd$Country_year == "ESP_2008"] <- 1338
    cses_imd$partywon[cses_imd$Country_year == "EST_2011"] <- 1150
    cses_imd$partywon[cses_imd$Country_year == "FIN_2003"] <- 901
    cses_imd$partywon[cses_imd$Country_year == "FIN_2007"] <- 901
    cses_imd$partywon[cses_imd$Country_year == "FIN_2011"] <- 495
    cses_imd$partywon[cses_imd$Country_year == "FIN_2015"] <- 901
    cses_imd$partywon[cses_imd$Country_year == "FRA_2002"] <- 1595
    cses_imd$partywon[cses_imd$Country_year == "FRA_2007"] <- 1595
    cses_imd$partywon[cses_imd$Country_year == "FRA_2012"] <- 1478
    cses_imd$partywon[cses_imd$Country_year == "GBR_1997"] <- 1516
    cses_imd$partywon[cses_imd$Country_year == "GBR_2005"] <- 1516
    cses_imd$partywon[cses_imd$Country_year == "GBR_2015"] <- 1567
    cses_imd$partywon[cses_imd$Country_year == "GRC_2009"] <- 1468
    cses_imd$partywon[cses_imd$Country_year == "GRC_2012"] <- 794
    cses_imd$partywon[cses_imd$Country_year == "GRC_2015"] <- 301
    cses_imd$partywon[cses_imd$Country_year == "HRV_2007"] <- 1431
    cses_imd$partywon[cses_imd$Country_year == "HUN_1998"] <- 1691
    cses_imd$partywon[cses_imd$Country_year == "HUN_2002"] <- 1408
    cses_imd$partywon[cses_imd$Country_year == "IRL_2002"] <- 1055
    cses_imd$partywon[cses_imd$Country_year == "IRL_2007"] <- 1055
    cses_imd$partywon[cses_imd$Country_year == "IRL_2011"] <- 1288
    cses_imd$partywon[cses_imd$Country_year == "ISL_1999"] <- 615
    cses_imd$partywon[cses_imd$Country_year == "ISL_2003"] <- 363
    cses_imd$partywon[cses_imd$Country_year == "ISL_2007"] <- 363
    cses_imd$partywon[cses_imd$Country_year == "ISL_2009"] <- 1396
    cses_imd$partywon[cses_imd$Country_year == "ISL_2013"] <- 964
    cses_imd$partywon[cses_imd$Country_year == "ISR_1996"] <- 1036
    cses_imd$partywon[cses_imd$Country_year == "ISR_2003"] <- 1036
    cses_imd$partywon[cses_imd$Country_year == "ISR_2006"] <- 484
    cses_imd$partywon[cses_imd$Country_year == "ISR_2013"] <- 1036
    cses_imd$partywon[cses_imd$Country_year == "ITA_2006"] <- 802
    cses_imd$partywon[cses_imd$Country_year == "JPN_1996"] <- 1746
    cses_imd$partywon[cses_imd$Country_year == "KEN_2013"] <- 3867
    cses_imd$partywon[cses_imd$Country_year == "KGZ_2005"] <- 3599 
    cses_imd$partywon[cses_imd$Country_year == "KOR_2000"] <- 2548 
    cses_imd$partywon[cses_imd$Country_year == "KOR_2004"] <- 2452 
    cses_imd$partywon[cses_imd$Country_year == "KOR_2008"] <- 7655 
    cses_imd$partywon[cses_imd$Country_year == "KOR_2012"] <- 7655 
    cses_imd$partywon[cses_imd$Country_year == "LTU_1997"] <- 193 
    cses_imd$partywon[cses_imd$Country_year == "LVA_2010"] <- 1632 
    cses_imd$partywon[cses_imd$Country_year == "LVA_2011"] <- 1632 
    cses_imd$partywon[cses_imd$Country_year == "LVA_2014"] <- 852 
    cses_imd$partywon[cses_imd$Country_year == "MEX_2000"] <- 696 
    cses_imd$partywon[cses_imd$Country_year == "MEX_2006"] <- 696 
    cses_imd$partywon[cses_imd$Country_year == "MEX_2012"] <- 1474 
    cses_imd$partywon[cses_imd$Country_year == "MNE_2012"] <- 3162 
    cses_imd$partywon[cses_imd$Country_year == "NLD_1998"] <- 1234 
    cses_imd$partywon[cses_imd$Country_year == "NLD_2002"] <- 1157 
    cses_imd$partywon[cses_imd$Country_year == "NLD_2006"] <- 1157 
    cses_imd$partywon[cses_imd$Country_year == "NLD_2010"] <- 828 
    cses_imd$partywon[cses_imd$Country_year == "NOR_1997"] <- 705
    cses_imd$partywon[cses_imd$Country_year == "NOR_2001"] <- 705
    cses_imd$partywon[cses_imd$Country_year == "NOR_2005"] <- 448
    cses_imd$partywon[cses_imd$Country_year == "NOR_2009"] <- 448
    cses_imd$partywon[cses_imd$Country_year == "NOR_2013"] <- 503
    cses_imd$partywon[cses_imd$Country_year == "NZL_1996"] <- 1824
    cses_imd$partywon[cses_imd$Country_year == "NZL_2002"] <- 1119
    cses_imd$partywon[cses_imd$Country_year == "NZL_2008"] <- 1824
    cses_imd$partywon[cses_imd$Country_year == "NZL_2011"] <- 1824
    cses_imd$partywon[cses_imd$Country_year == "NZL_2014"] <- 1824
    cses_imd$partywon[cses_imd$Country_year == "PER_2001"] <- 4861
    cses_imd$partywon[cses_imd$Country_year == "PER_2006"] <- 529
    cses_imd$partywon[cses_imd$Country_year == "PER_2011"] <- 345
    cses_imd$partywon[cses_imd$Country_year == "PER_2016"] <- 6647
    cses_imd$partywon[cses_imd$Country_year == "PHL_2004"] <- 2388
    cses_imd$partywon[cses_imd$Country_year == "PHL_2010"] <- 2330
    cses_imd$partywon[cses_imd$Country_year == "PHL_2016"] <- 4602
    cses_imd$partywon[cses_imd$Country_year == "POL_1997"] <- 863
    cses_imd$partywon[cses_imd$Country_year == "POL_2001"] <- 57
    cses_imd$partywon[cses_imd$Country_year == "POL_2005"] <- 1565
    cses_imd$partywon[cses_imd$Country_year == "POL_2007"] <- 1117
    cses_imd$partywon[cses_imd$Country_year == "POL_2011"] <- 1117
    cses_imd$partywon[cses_imd$Country_year == "PRT_2002"] <- 1359
    cses_imd$partywon[cses_imd$Country_year == "PRT_2005"] <- 655
    cses_imd$partywon[cses_imd$Country_year == "PRT_2009"] <- 655
    cses_imd$partywon[cses_imd$Country_year == "PRT_2015"] <- 655
    cses_imd$partywon[cses_imd$Country_year == "ROU_1996"] <- 1750
    cses_imd$partywon[cses_imd$Country_year == "ROU_2004"] <- 481
    cses_imd$partywon[cses_imd$Country_year == "ROU_2009"] <- 660
    cses_imd$partywon[cses_imd$Country_year == "ROU_2012"] <- 120
    cses_imd$partywon[cses_imd$Country_year == "ROU_2014"] <- 120
    cses_imd$partywon[cses_imd$Country_year == "RUS_1999"] <- 2242
    cses_imd$partywon[cses_imd$Country_year == "RUS_2000"] <- 2242
    cses_imd$partywon[cses_imd$Country_year == "SRB_2012"] <- 2178
    cses_imd$partywon[cses_imd$Country_year == "SVK_2010"] <- 983
    cses_imd$partywon[cses_imd$Country_year == "SVK_2016"] <- 311
    cses_imd$partywon[cses_imd$Country_year == "SVN_1996"] <- 975
    cses_imd$partywon[cses_imd$Country_year == "SVN_2004"] <- 472
    cses_imd$partywon[cses_imd$Country_year == "SVN_2008"] <- 1403
    cses_imd$partywon[cses_imd$Country_year == "SVN_2011"] <- 1403
    cses_imd$partywon[cses_imd$Country_year == "SWE_1998"] <- 487
    cses_imd$partywon[cses_imd$Country_year == "SWE_2002"] <- 487
    cses_imd$partywon[cses_imd$Country_year == "SWE_2006"] <- 690
    cses_imd$partywon[cses_imd$Country_year == "SWE_2014"] <- 487
    cses_imd$partywon[cses_imd$Country_year == "THA_2007"] <- NA
    cses_imd$partywon[cses_imd$Country_year == "THA_2011"] <- 5398
    cses_imd$partywon[cses_imd$Country_year == "TUR_2011"] <- 306
    cses_imd$partywon[cses_imd$Country_year == "TUR_2015"] <- 306
    cses_imd$partywon[cses_imd$Country_year == "TWN_1996"] <- 1112
    cses_imd$partywon[cses_imd$Country_year == "TWN_2001"] <- 1596
    cses_imd$partywon[cses_imd$Country_year == "TWN_2004"] <- 1596
    cses_imd$partywon[cses_imd$Country_year == "TWN_2008"] <- 1112
    cses_imd$partywon[cses_imd$Country_year == "TWN_2012"] <- 1112
    cses_imd$partywon[cses_imd$Country_year == "URY_2009"] <- 1658
    cses_imd$partywon[cses_imd$Country_year == "USA_1996"] <- 432
    cses_imd$partywon[cses_imd$Country_year == "USA_2004"] <- 809
    cses_imd$partywon[cses_imd$Country_year == "USA_2008"] <- 432
    cses_imd$partywon[cses_imd$Country_year == "USA_2012"] <- 432
    cses_imd$partywon[cses_imd$Country_year == "ZAF_2009"] <- 1219
    cses_imd$partywon[cses_imd$Country_year == "ZAF_2014"] <- 1219
    
#Winning Party ID         
    cses_imd$Winner <- 0
    cses_imd$Winner[cses_imd$partyid == cses_imd$partywon] <- 1 
    
#Loser 
    cses_imd$Loser <- 0 
    cses_imd$Loser[cses_imd$Partisan == 1 & cses_imd$Winner == 0] <- 1

#Year 
    cses_imd$year <- cses_imd$IMD1008_YEAR
    
    
#Keep Variable Needed From Cses before merging.
    cses_imd = subset(cses_imd, select = c(Partisan,partywon,partyid,Country_year,Income,Education,Satisfaction,Age,Female,Loser,Winner,year))
    
#Extract County-level Variables from Williams et al. data
    
    load("~/Downloads/Winners_Losers_Analysis_ES.RData")
    WS <- table 
    remove(table)
    
    #Reformats the data where the unit is country year and not survey respondent
    library(dplyr)
    WS = WS  %>% group_by(Country_year) %>%
    ...
    #We need to merge country level data to the Cses data. 
    cses_imd <- merge(WS, cses_imd, by=c("Country_year"))
    
    #We no long need Williams et al data so we can remove it 
    remove(WS)
  
    
#Merging our survey data with V-Party. This must be done two steps. 
    
    VP <- readRDS("~/Downloads/CPD_V-Party_R_v1/V-Dem-CPD-Party-V1.rds")
    VP = subset(VP, select = c(year,v2paid,v2pawomlab,v2pagender,v2patotalseat,v2paseatshare,country_name))
    VP$partywon <- VP$v2paid
    VP = subset(VP, select = -c(v2paid) )
    ...
    cses_imd <- merge(cses_imd, VP, by=c("partywon","year"))
      ...
      cses_imd$Winner_GenderEqu <- cses_imd$v2pagender
      cses_imd$Winner_totalseats <- cses_imd$v2patotalseat
      cses_imd$Winner_seatsgained <- cses_imd$v2paseatshare
      
      cses_imd = subset(cses_imd, select = -c(v2pawomlab,v2pagender,v2patotalseat,v2paseatshare) )
      
     #Step 2: Merge based on party id of respondent (party-level)
      ...
      cses_imd$Your_seatsgained <- cses_imd$v2paseatshare
